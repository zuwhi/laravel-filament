...
<html>
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Patrick+Hand&family=Sriracha&family=Itim&display=swap"
            rel="stylesheet">
    ...
    <body>
        <div class="overlay">
            <div class="cover">
                ...
                <div class="awalan">
                    ...
                    <label style="font-size:16px">Htmlku.com/pesanuntukmu</label>
                </div>
            </div>
        </div>

        <div id="bodyblur">
            <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhqjeQ7NlN92_dwtxYNCtLFpPe9lMt_zffq06EPVGF53aqoeBoy3wNq4j6BSPtc8f_ciXlX07xs1mSjgaSpXZUwpYXg2JJxl4D1iVjpdspfHiScLSgqfKTJIHtH4OmpG8Gk1Br8sByutqxjx-s1H-gY8LQCLjWPWyqQ6SsJFac-IGfZq05gxRp3CemyatUy/s1200/1000322477.jpg"
                id="wallpaper" />
            <div id="thisblur"></div>
        </div>
        ...
        <div class="container" id="container">
            <p class="titleC"><b>Alooo Kamuu! <strong class="bigText">Niluh SRIII !!!</strong></b></p>
            <script>
                teksAnimasi = [
